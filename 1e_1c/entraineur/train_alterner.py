...
for k in range(1, loop+1):
    ...
    run_name_chasseur = f"chasseur{k}_al_{run_number}"
    wandb.init(
    ...
    path_norm_chasseur = f"C:/Users/FX643778/Documents/Git/Interception_marl/1e_1c/models/alterner/run{run_number}/chasseur/chasseur{k-1}_al_{run_number}_vecnormalize.pkl"
    path_model_chasseur = f"C:/Users/FX643778/Documents/Git/Interception_marl/1e_1c/models/alterner/run{run_number}/chasseur/chasseur{k-1}_al_{run_number}.zip"
    ...
    run_name_eviteur = f"eviteur{k}_al_{run_number}"
    wandb.init(
    ...
    path_norm_chasseur = f"C:/Users/FX643778/Documents/Git/Interception_marl/1e_1c/models/alterner/run{run_number}/chasseur/chasseur{k}_al_{run_number}_vecnormalize.pkl"
    path_model_chasseur = f"C:/Users/FX643778/Documents/Git/Interception_marl/1e_1c/models/alterner/run{run_number}/chasseur/chasseur{k}_al_{run_number}.zip"
