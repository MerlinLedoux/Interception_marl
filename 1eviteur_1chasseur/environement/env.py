...
class Affrontement(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.current_step = 0
        self.id += 1
        self.dist_min = np.linalg.norm(self.pos_eviteur - self.pos_chasseur)
    ...
    def step(self, action_dict):
        ...
        temp = np.linalg.norm(self.pos_eviteur - self.pos_chasseur)
        self.dist_min = min(self.dist_min, temp )
        ...
        if self.current_step >= self.max_step:
            ...
            if np.linalg.norm(self.pos_eviteur - self.pos_objectif) < 30:
                ...
                rewards = {"eviteur": 100, "chasseur": -100 - self.dist_min}
                ...
                rewards = {"eviteur": (dist_evit_obj_mem - dist_evit_obj_new)/10 - proche, "chasseur": (dist_cha_evit_mem - dist_cha_evit_new)/30}
